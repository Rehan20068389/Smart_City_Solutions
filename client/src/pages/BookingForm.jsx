//Referance from youtube:"https://youtu.be/tBObk72EYYw?si=2z-csRfIaL6bMlB6"
  ...
  async function submit(e) {
    ...
    try {
      const payload = {
        ...
        pickupLocation: form.serviceType === "car" ? form.pickupLocation : null,
        dropLocation: form.serviceType === "car" ? form.dropLocation : null
      };
      ...
      <div>
        ...
        >
          ...
          {form.serviceType === "car"
            ? cars.map(c => <option key={c.id} value={c.id}>{c.model} ({c.type})</option>)
